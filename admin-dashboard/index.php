...
<head>
    ...
    <style>
        ...
        /* Calendar Styles */
        .calendar-container { background: white; border-radius: 24px; padding: 24px; border: 1px solid rgba(1, 20, 120, 0.05); margin-bottom: 20px; display: none; animation: fadeIn 0.3s ease; }
...
<body>
        ...
        <div class="content">
            ...
            <div class="toolbar">
                ...
                <div class="toolbar-actions">
                    ...
                    <button onclick="toggleCalendar()" class="btn-export" id="btn-toggle-calendar">View Calendar</button>
            ...
            <div id="calendar-view" class="calendar-container">
                ...
                <div style="margin-top: 16px; display: flex; flex-wrap: wrap; gap: 16px; font-size: 12px; color: rgba(1,20,120,0.7); font-weight: 500;">
                    ...
                    <div style="display: flex; align-items: center; gap: 6px;"><span style="width:12px;height:12px;border-radius:3px;background:#fee2e2;"></span> Blocked</div>
                </div>
            </div>
    ...
    <script>
        ...
        function toggleCalendar() {
            ...
            document.getElementById('calendar-view').style.display = isCalendarVisible ? 'block' : 'none';
            document.getElementById('btn-toggle-calendar').textContent = isCalendarVisible ? 'Hide Calendar' : 'View Calendar';
            if (isCalendarVisible) renderCalendar();
        }
