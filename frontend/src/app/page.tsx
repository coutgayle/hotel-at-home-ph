    ...
    <main className="bg-brand-white text-brand-blue">
          ...
          <div className="relative z-10 flex items-center justify-center px-6">
            <div className="text-center max-w-2xl">
              ...
              <div className="mt-10 flex justify-center">
                <Link
                  href="/rooms"
                  className="inline-flex items-center gap-2 rounded-full bg-accent px-7 py-3 text-sm font-semibold text-brand-blue transition hover:bg-yellow-300"
                >
                  Explore Our Rooms
      ...
      <section className="relative -mt-10 px-6 pb-20 z-10">
        <div className="mx-auto max-w-7xl">
          <div className="overflow-hidden rounded-[40px] bg-brand-white px-8 py-10 shadow-md shadow-primary-dark/10">
              ...
              <div className="flex items-end pb-4">
                <button type="submit" className="w-full rounded-3xl border border-transparent bg-brand-blue px-4 py-3 text-sm font-semibold text-brand-white shadow-sm transition hover:bg-[#001a72]">
                  Check Availability
                </button>
              </div>
            </form>
